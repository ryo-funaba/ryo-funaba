...
- 受託開発企業
  ...
  - 不動産 DX サービス
    ...
    - サービス概要
      ...
      - 上記サービスを導入することで、チャットベースでやりとりが行えるため、忙しい平日や夜中でも管理会社に連絡が可能になる
      - 他の機能として、掲示板機能、契約情報の確認、入居中サービス、各種申請など全てアプリケーション上から行える
    - チームの特徴・課題
      - 導入数が業界首位の入居者管理サービスを、開発元の他社から引き継ぐことになり、社内の立ち上げメンバーとして参加
      - 引き継ぎ当初はドキュメントの不足や属人的な運用体制が課題であったため、それらを解消するアクションを取り、開発スピード向上に貢献した
    - チームでの役割
    ...
    - チームの課題と自身が工夫したこと
      ...
      - 具体的な内容は次の 4 つ
        ...
        - 新規メンバー参加時の学習コストの削減
      - 引き継ぎ当初は多くの課題を抱えていたサービスであったが、徹底的に負債解消のアクションを取ったことで、今では豊富なドキュメントが揃い、迅速に開発を進められるように改善された
    - 成果
...
- 医療系スタートアップ企業
  ...
  - オンライン服薬サービス
    ...
    - チームの特徴・課題
      - 2020 年にコロナが流行し、オンライン診療・服薬に大きな需要が生まれたことで、上記サービスは著しい成長を実現した
