...
- 本質的なユーザーの課題解決を考慮した設計・開発・テスト
- E2E 自動テスト、モックサーバの導入

## バリューを発揮しやすい環境

- 解決手段にとらわれることなく、ユーザーの課題やプロダクトの提供価値に向き合っている
- 仕事の領域を制限せずユーザーストーリー達成のために必要なアクションを行えるチーム
- 気軽に雑談できる心理的安全性の高いチーム

## 意欲・興味

- 開発経験を活かした非機能テスト、探索的テスト、セキュリティテストの実施
- シフトレフトによる品質リスクの予測と対策
...
Datadog・Docker・OpenAPI・Playwright・RSpec・Terraform
